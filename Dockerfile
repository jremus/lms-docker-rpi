...
RUN wget --progress=dot:mega -O /tmp/lms.deb http://downloads.slimdevices.com/LogitechMediaServer_v7.7.5/logitechmediaserver_7.7.5_all.deb \
 && dpkg -i /tmp/lms.deb \
 && rm /tmp/lms.deb
